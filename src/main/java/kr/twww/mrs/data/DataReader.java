...
public interface DataReader
{
     ...
     * @return 데이터 파일 경로
     */
    String GetPathFromDataType( DataType dataType ) throws Exception;
     ...
     * @return 파일 텍스트 내용
     */
    String ReadTextFromFile( String path ) throws Exception;
     ...
     * @return 평가 데이터 리스트
     */
    ArrayList<Rating> GetRatingList() throws Exception;
